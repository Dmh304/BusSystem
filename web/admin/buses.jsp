        ...
        <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="card">
                    ...
                    <button type="button" onclick="showAddBusForm()"
                        style="padding: 8px 15px; background-color: #28a745; color: white; border: none; cursor: pointer; border-radius: 4px; margin-bottom: 10px;">Add
                        New Bus</button>
                </div>

                <div class="card" id="busFormDiv"
                    style="display: none; background-color: #f8f9fa; border: 1px solid #ddd;">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/buses" method="post"
                        ...
                        <input type="text" name="plateNumber" id="plateNumber" placeholder="Plate Number" required
                            style="padding: 8px;">
                        ...
                        <button type="submit"
                            style="padding: 8px 15px; background-color: #007bff; color: white; border: none; cursor: pointer; border-radius: 4px;">Save</button>
                        <button type="button" onclick="hideBusForm()"
                            style="padding: 8px 15px; background-color: #6c757d; color: white; border: none; cursor: pointer; border-radius: 4px;">Cancel</button>
                    </form>
                </div>

                <div class="card" id="assignFormDiv"
                    style="display: none; background-color: #e9ecef; border: 1px solid #ced4da;">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/buses" method="post"
                        ...
                        <button type="submit"
                            style="padding: 8px 15px; background-color: #007bff; color: white; border: none; cursor: pointer; border-radius: 4px;">Assign</button>
                    ...
                    <table>
                        ...
                        <c:forEach items="${buses}" var="item">
                            <tr>
                                ...
                                <td>
                                    <button type="button" onclick="showEditBusForm(this)" data-id="${item.busId}"
                                        data-plate="${item.plateNumber}" data-name="${item.busName}"
                                        data-capacity="${item.capacity}" data-status="${item.status}"
                                    ...
                                    <form action="${pageContext.request.contextPath}/admin/buses" method="post"
                                        ...
                                        onsubmit="return confirm('Are you sure you want to deactivate this bus?');">
                                        <input type="hidden" name="action" value="delete">
                                        <input type="hidden" name="busId" value="${item.busId}">
                                        <button type="submit"
                                            style="padding: 5px 10px; cursor: pointer; border: none; background-color: #dc3545; color: white; border-radius: 4px; margin-bottom: 5px;">Delete</button>
                                    </form>
                                    <br />
                                    <button type="button"
                                        onclick="showAssignForm('${item.busId}', '${item.plateNumber}')"
                                        style="padding: 5px 10px; cursor: pointer; border: none; background-color: #17a2b8; color: white; border-radius: 4px;">Assign
                                        Team</button>
                                </td>
                            </tr>
                        </c:forEach>
